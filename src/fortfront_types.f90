module fortfront_types
    ...
    integer, parameter :: NODE_PAUSE = 29
    integer, parameter :: NODE_CYCLE = 30
    integer, parameter :: NODE_EXIT = 31
    integer, parameter :: NODE_WHERE = 32
    integer, parameter :: NODE_INTERFACE_BLOCK = 33
    integer, parameter :: NODE_DERIVED_TYPE = 34
    integer, parameter :: NODE_POINTER_ASSIGNMENT = 35
    integer, parameter :: NODE_FORALL = 36
    integer, parameter :: NODE_CASE_RANGE = 37
    integer, parameter :: NODE_CASE_DEFAULT = 38
    integer, parameter :: NODE_COMPLEX_LITERAL = 39
    integer, parameter :: NODE_INCLUDE_STATEMENT = 40
    integer, parameter :: NODE_CONTAINS = 41
    integer, parameter :: NODE_FORMAT_DESCRIPTOR = 42
    integer, parameter :: NODE_COMMENT = 43
    integer, parameter :: NODE_IMPLICIT_STATEMENT = 44
    integer, parameter :: NODE_FORMAT_STATEMENT = 45
    integer, parameter :: NODE_CONTINUE = 46
