module cfg_builder_control_handlers
    ...
    ! Public interface
    public :: process_if_statement, process_do_loop, process_do_while
    public :: process_select_case, process_return, process_stop
    public :: process_exit, process_cycle, process_goto, process_error_stop
    public :: process_node
    public :: process_procedure, process_where, process_forall
    public :: process_allocate, process_deallocate, process_io_with_exception
...
end module cfg_builder_control_handlers