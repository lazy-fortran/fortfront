...
contains
    ...
    function create_error_node(message, original_data, line, column) result(node)
        ...
        ! Use inherited line and column fields from ast_node
    ...
    subroutine error_node_cleanup(this)
        ...
        ! NEVER manually deallocate allocatable instances per Fortran rules
        ! Fortran handles automatic deallocation when variables go out of scope
        this%error_code = 0
    end subroutine
