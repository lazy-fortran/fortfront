...
contains
    ...
    function push_pointer_assignment(arena, pointer_index, target_index, line, column, parent_index) result(assign_index)
        type(ast_arena_t), intent(inout) :: arena
 ...
 function push_parameter_declaration(arena, name, type_name, kind_value, intent_value, &
    ...
    function push_select_case(arena, selector_index, case_indices, line, column, parent_index) result(select_index)
        type(ast_arena_t), intent(inout) :: arena
    ...
    function push_select_case_with_default(arena, selector_index, case_indices, default_index, &
    ...
    function push_case_block(arena, value_indices, body_indices, line, column, parent_index) result(case_index)
        type(ast_arena_t), intent(inout) :: arena
    ...
    function push_case_range(arena, start_value, end_value, line, column, parent_index) result(range_index)
        type(ast_arena_t), intent(inout) :: arena
    ...
    function push_case_default(arena, body_indices, line, column, parent_index) result(default_index)
        type(ast_arena_t), intent(inout) :: arena
        integer, intent(in), optional :: body_indices(:)
        integer, intent(in), optional :: line, column, parent_index
  ...
  function push_cycle(arena, loop_label, line, column, parent_index) result(cycle_index)
    ...
    function push_where_construct_with_elsewhere(arena, mask_expr_index, where_body_indices, &
    ...
    function push_type_constructor(arena, type_name, arg_indices, line, column, parent_index) result(constructor_index)
        type(ast_arena_t), intent(inout) :: arena
        character(len=*), intent(in) :: type_name
        integer, intent(in), optional :: arg_indices(:)
        integer, intent(in), optional :: line, column, parent_index
    ...
    function push_component_access(arena, object_index, component_name, line, column, parent_index) result(access_index)
        type(ast_arena_t), intent(inout) :: arena
        ...
        access_node%right_index = push_identifier(arena, component_name, parent_index=parent_index)
    ...
    function push_complex_literal(arena, real_index, imag_index, line, column, parent_index) result(complex_index)
        type(ast_arena_t), intent(inout) :: arena
