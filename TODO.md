...
1. **Legacy Audit & Removal**
   ...
   - [x] Drop stale tests/docs covering removed behaviour; replace with canonical SOT parser expectations (updated example README + xfail reasons for Pratt duplicate-program bug).
...
- 2025-09-19 (local, perf n/a): Updated example docs and xfail reasons to reflect Pratt parser
  duplicate-program output; removed references to the deprecated recursive expression errors.
